    ...
    real(kind=4),dimension(np,nt,nr),intent(in) :: scalin
    integer,intent(in) :: nfiles

    ! local variables
    character(len=20) :: scalnames(2)
    character(len=20) :: vecnames(0)
    real(kind=4),dimension(3,np*(nt/nfiles+1)*nr) :: xyz
    real(kind=4),dimension(2,np*(nt/nfiles+1)*nr) :: scals
    real(kind=4),dimension(0,0,0) :: vecs
    !real(kind=4),dimension(1,np*(nt/nfiles+1)*nr) :: scals
...
!-------------------------------------------------------------------------
    ...
    integer,intent(in) :: minc
    real(kind=4),dimension(nr),intent(in) :: radius
    real(kind=4),dimension(np,nt,nr),intent(in) :: vr,vt,vp
    integer,intent(in) :: nfiles
    ...
    real(kind=4),dimension(3,np*(nt/nfiles+1)*nr) :: xyz
    real(kind=4),dimension(1,np*(nt/nfiles+1)*nr) :: scals
    real(kind=4),dimension(1,3,np*(nt/nfiles+1)*nr) :: vecs
    real(kind=4),dimension(nt) :: theta
    real(kind=4),dimension(np) :: phi
    real(kind=4) :: pi,vs
    integer(kind=4) :: nnos
...
!-------------------------------------------------------------------------
    ...
    real(kind=4),dimension(np,nt,nr),intent(in) :: scal1,scal2

    ! local variables
    character(len=20) :: scalnames(4),vecnames(1)
    real(kind=4),dimension(3,np*nt*nr) :: xyz
    real(kind=4),dimension(4,np*nt*nr) :: scals
