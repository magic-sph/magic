...
#elif WITH_ACC_GPU
         !$acc enter data create(xiMat_fac)
         !$acc kernels
         xiMat_fac(:,:) = 0.0_cp
         !$acc end kernels
#endif
...
#elif WITH_ACC_GPU
         !$acc enter data create(xi_ghost)
         !$acc kernels
         xi_ghost(:,:)=zero
         !$acc end kernels
#endif
...
#elif WITH_ACC_GPU
         !$acc exit data delete(xiMat_fac)
#endif
...
#elif WITH_ACC_GPU
         !$acc exit data delete(xi_ghost, fd_fac_top, fd_fac_bot)
#endif
...
#elif WITH_ACC_GPU
      !$acc enter data create(dxi, work_Rloc)
      !$acc kernels
      dxi(:,:) = zero
      work_Rloc(:,:) = zero
      !$acc end kernels
...
#elif WITH_ACC_GPU
      !$acc exit data delete(dxi, work_Rloc)
#endif
