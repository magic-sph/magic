...
contains
  ...
  SUBROUTINE getEgeos(time,nGeosSets,w,dw,ddw,z,dz,               &
    ...
    REAL(kind=8) :: dpFlow,dzFlow ! RMS length scales
    ...
    !$OMP  PRIVATE(nS,lTC,zMin,zMax,nZmax,nZ,thetaZ,nPhi,                   &
    !$OMP          VrS,VtS,VpS,VozS,nInts,nInt,help,VrInt,VtInt,VpInt,      &
    !$OMP          EkInt,dpEkInt,dzEkInt,VrIntS,VtIntS,VpIntS,              &
    !$OMP          EkIntS,dpEkIntS,dzEkIntS,sinT,cosT,nZS,nZN,              &
    !$OMP          VzS,VzN,VzSN,VzSS,VzNN,VorS,VorN,VorSN,VorSS,VorNN,      &
    !$OMP          HelZZ,VZZ,VorZZ,CVz_I,CVor_I,CHel_I)
