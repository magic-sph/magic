...
!------------------------------------------------------------------------------
   subroutine do_iteration_ThetaBlocking_seq(this,nR,nBc,time,timeStage, &
      ...
      print *, " * Deprecated function do_iteration_ThetaBlocking_seq, doing nothing!!"
...
!             call get_br_v_bcs_DEPRECATED(this%gsa%brc,this%gsa%vtc,this%gsa%vpc, &
...
!             call get_lorentz_torque_DEPRECATED(lorentz_torque_ic,nThetaStart,     &
...
!             call get_lorentz_torque_DEPRECATED(lorentz_torque_ma,nThetaStart,     &
!                  &                  this%sizeThetaB,this%gsa%brc,      &
!                  &                  this%gsa%bpc,this%nR)
!          end if
!          PERFOFF
...
!             call courant_DEPRECATED(this%nR,this%dtrkc,this%dthkc,this%gsa%vrc, &
