...
!------------------------------------------------------------------------------
   subroutine fft_many(g,f)
      ...
      !-- Output variable
      complex(cp), intent(out) :: f(n_theta_loc,n_phi_max/2+1)

      !-- Local variables
      integer :: nt, np, nThStart, nThStop, nThLoc
      real(cp) :: tmp(n_theta_loc,n_phi_max+2),work(n_theta_loc,n_phi_max+1)
...
!------------------------------------------------------------------------------
   subroutine ifft_many(f,g)
      ...
      !-- Output variable
      real(cp), intent(out) :: g(n_theta_loc,n_phi_max)
