...
!-- Output:
    REAL(kind=8) :: bMat(n_r_totMag,n_r_totMag)
    INTEGER :: bPivot(n_r_totMag)
    REAL(kind=8) :: jMat(n_r_totMag,n_r_totMag)
    INTEGER :: jPivot(n_r_totMag)
