...
module output_data
   ...
   !----- Output time control:
   real(kind=8), public :: t_graph_start,t_graph_stop,dt_graph
   real(kind=8), public :: t_rst_start,t_rst_stop,dt_rst
   real(kind=8), public :: t_log_start,t_log_stop,dt_log
   real(kind=8), public :: t_p_start,t_p_stop,dt_p
   real(kind=8), public :: t_spec_start,t_spec_stop,dt_spec
   real(kind=8), public :: t_diag_start,t_diag_stop,dt_diag
   real(kind=8), public :: t_cmb_start,t_cmb_stop,dt_cmb
   real(kind=8), public :: t_r_field_start,t_r_field_stop,dt_r_field
   real(kind=8), public :: t_TO_start,t_TO_stop,dt_TO
   real(kind=8), public :: t_TOZ_start,t_TOZ_stop,dt_TOZ
   real(kind=8), public :: t_movie_start,t_movie_stop,dt_movie
   real(kind=8), public :: t_TOmovie_start,t_TOmovie_stop,dt_TOmovie
   real(kind=8), public :: t_Bpot_start,t_Bpot_stop,dt_Bpot
   real(kind=8), public :: t_Vpot_start,t_Vpot_stop,dt_Vpot
   real(kind=8), public :: t_Tpot_start,t_Tpot_stop,dt_Tpot
   real(kind=8), public :: t_pot_start,t_pot_stop,dt_pot
   ...
   real(kind=8), public ::  t_graph(n_time_hits)
   real(kind=8), public ::  t_rst(n_time_hits)
   real(kind=8), public ::  t_log(n_time_hits)
   real(kind=8), public ::  t_p(n_time_hits)
   real(kind=8), public ::  t_spec(n_time_hits)
   real(kind=8), public ::  t_diag(n_time_hits)
   real(kind=8), public ::  t_cmb(n_time_hits)
   real(kind=8), public ::  t_r_field(n_time_hits)
   real(kind=8), public ::  t_movie(n_time_hits)
   real(kind=8), public ::  t_TO(n_time_hits)
   real(kind=8), public ::  t_TOZ(n_time_hits)
   real(kind=8), public ::  t_TOmovie(n_time_hits)
   real(kind=8), public ::  t_Bpot(n_time_hits)
   real(kind=8), public ::  t_Vpot(n_time_hits)
   real(kind=8), public ::  t_Tpot(n_time_hits)
   real(kind=8), public ::  t_pot(n_time_hits)
   ...
   !----- Z-integrated output:
   real(kind=8), public :: zDens,sDens
 
   !----- RMS cut radius and dealiasing:
   real(kind=8), public :: rCut,rDea
