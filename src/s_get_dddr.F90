...
!-- Work arrays:
    ...
    REAL(kind=8) :: work2(n_f_max,*) ! work array needed for costf

!-- output:
    REAL(kind=8) :: df(n_f_max,*)    ! first derivative of f
    REAL(kind=8) :: ddf(n_f_max,*)   ! second derivative of f
    REAL(kind=8) :: dddf(n_f_max,*)  ! third derivative of f
...
!-- Get derivatives:
    CALL get_dddcheb(work2,df,ddf,dddf,           &
...
!-- Transform back:
    ...
    CALL costf1(ddf,n_f_max,n_f_start,n_f_stop,   &
                work1,i_costf_init,d_costf_init)
    CALL costf1(dddf,n_f_max,n_f_start,n_f_stop,  &
                work1,i_costf_init,d_costf_init)
