module init_fields
   ...
   use sht, only: scal_to_SH, scal_to_spat, sht_l_single
   ...
   subroutine initV(w,z,omega_ic,omega_ma)
      ...
      if ( init_v1 == 1 .and. ( omega_ic1 /= 0.0_cp .or. omega_ma1 /= 0.0_cp ) ) then
         ...
         do nR=nRstart,nRstop
            ...
            call scal_to_SH(sht_l_single, ome, omeLM, l_max)
...
!--------------------------------------------------------------------
   subroutine initS(s,p)
      ...
      do nS=1,n_impS
         ...
         call scal_to_SH(sht_l_single, sCMB, sLM, l_max)
...
!---------------------------------------------------------------------------
   subroutine initXi(xi)
      ...
      do nXi=1,n_impXi
         ...
         call scal_to_SH(sht_l_single, xiCMB, xiLM, l_max)
   ...
   subroutine initPhi(s, phi)
      ...
      if ( init_phi == 1 ) then
         ...
         do n_r=nRstart,nRstop
            call scal_to_spat(sht_l_single, s_Rloc(:,n_r), temp_Rloc(:,:,n_r), l_max)
         end do
...
!-----------------------------------------------------------------------
   subroutine initF(bodyForce)
      ...
      do nR = nRstart,nRstop
         ...
         call scal_to_SH(sht_l_single, bf_spat, bfLM, l_max)
