...
!--INPUT:
    real(kind=8) :: theta ! angle in degrees
    integer :: max_degree ! required max degree of plm
    integer :: max_order  ! required max order of plm
    integer :: m0         ! basic wave number
    integer :: ndim_plma  ! dimension of plma and dtheta_plma
    integer :: norm       ! =0 fully normalised
! =1 Schmidt normalised

!-- OUTPUT:
    real(kind=8) :: plma(ndim_plma) ! ass. legendres at theta
    real(kind=8) :: dtheta_plma(ndim_plma) ! their theta derivative
