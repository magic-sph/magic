...
radial space for spherical harmonics degree up to :ref:`l_max_pot <varl_max_pot>`.
...
following structure
   ...
   .. code-block:: fortran
       ...
       !-------------
       version
       time, ra, pr, raxi, sc, prmag, ek, radratio, sigma_ratio           ! Parameters
       n_r_max, n_r_ic_max, l_max_pot, minc, lm_max_pot, m_min, m_max_pot ! Truncation
       ...
       !-------------
       w(lm=1,n_r=1), w(lm=2, n_r=1), ..., w(lm=lm_max_pot, n_r=1),
       ...
       w(lm=1,n_r=n_r_max), ..., w(lm=lm_max_pot,n_r=n_r_max)

       !-------------
       ! If stored: toroidal potential
       !-------------
       z(lm=1,n_r=1), z(lm=2, n_r=1), ..., z(lm=lm_max_pot, n_r=1),
       ...
       z(lm=1,n_r=n_r_max), ..., z(lm=lm_max_pot,n_r=n_r_max)

       !**************************************************************************!
       ! This last part is optional and are is written when there is              !
       ! an electrically-conducting inner-core                                    !
       !**************************************************************************!
       b_ic(lm=1,n_r=1), b_ic(lm=2, n_r=1), ..., b_ic(lm=lm_max_pot, n_r=1),
       ...
       b_ic(lm=1,n_r=n_r_max), ..., b_ic(lm=lm_max_pot,n_r=n_r_max)
       aj_ic(lm=1,n_r=1), aj_ic(lm=2, n_r=1), ..., aj_ic(lm=lm_max_pot, n_r=1),
       ...
       aj_ic(lm=1,n_r=n_r_max), ..., aj_ic(lm=lm_max_pot,n_r=n_r_max)
